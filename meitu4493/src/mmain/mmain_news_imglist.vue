<template>
    <div style="background-color:rgba(0, 0, 0, .25) ">
        ...
        <list class="list"  loadmoreoffset="10">
            ...
            <cell>
                <mmain_slider :taghref="taghref"></mmain_slider>
            </cell>

            <cell v-for="stockitem in stockArray">
                <mmain_news_imglist_item :stockitem="stockitem"></mmain_news_imglist_item>
            </cell>

            <cell>
                <mmain_tuijian_imglist :taghref="taghref"></mmain_tuijian_imglist>
            </cell>
...
<script>
    ...
    import  mmain_news_imglist_item from '../mmain/mmain_news_imglist_item.vue'
    import  mmain_slider from '../mmain/mmain_slider.vue'
    import  mmain_tuijian_imglist from '../mmain/mmain_tuijian_imglist.vue'
    ...
    export default{
        components: {
            mmain_news_imglist_item,
            navbar_v,
            mmain_slider,
            mmain_tuijian_imglist
