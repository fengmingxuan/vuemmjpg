    ...
    <div style="background-color:rgba(0, 0, 0, .25) ">
        ...
        <list class="list"  loadmoreoffset="10">
            ...
            <cell v-for="tpicNitem in tpicNArray">
                <pctopnav_alllist_item :tpicNitem="tpicNitem"></pctopnav_alllist_item>
            </cell>
...
<script>
    ...
    import  pctopnav_alllist_item from '../topnav/pctopnav_alllist_item.vue'
