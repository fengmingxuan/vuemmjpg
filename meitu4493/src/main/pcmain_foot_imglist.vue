    ...
    <div style="background-color:rgba(0, 0, 0, .25) ">
        ...
        <list class="list"  loadmoreoffset="10">
            ...
            <cell v-for="stockitem in stockArray">
                <pcmain_foot_imglist_item :stockitem="stockitem"></pcmain_foot_imglist_item>
            </cell>
            <!--<cell>-->
...
<script>
    ...
    import  pcmain_foot_imglist_item from '../main/pcmain_foot_imglist_item.vue'
