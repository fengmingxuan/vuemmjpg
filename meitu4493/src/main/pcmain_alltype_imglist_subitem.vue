<template>
    <div style="flex-direction: row;flex: 1;margin: 5px;">
        <div class="news-content" @click="todetail(stockitem.id,stockitem.href,stockitem.title)">
            <image class="img" :src="stockitem.src" v-if="stockitem.showimg"></image>
            <text class="txt" @click="todetail(stockitem.id,stockitem.href,stockitem.title)">{{stockitem.title}}</text>
            <div style="flex-direction: row;flex: 1" v-if="stockitem.showimg">
        ...
        <div class="news-content" @click="todetail(stockitem.id2,stockitem.href2,stockitem.title2)">
            <image class="img" :src="stockitem.src2" v-if="stockitem.showimg2"></image>
            <text class="txt" @click="todetail(stockitem.id2,stockitem.href2,stockitem.title2)">{{stockitem.title2}}</text>
            <div style="flex-direction: row;flex: 1" v-if="stockitem.showimg2">
                <image class="icon" :src="getImgUrl('./images/time.png')" ></image>
