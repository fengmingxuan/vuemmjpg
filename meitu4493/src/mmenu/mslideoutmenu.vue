   ...
   <div class="wrapper">
    ...
    <div id="main" class="panel" v-bind:style="{ left: panelleft}" @click="toggle">
        <!--<div class="btn-hamburger" >-->
            <mmain_news_imglist></mmain_news_imglist>
        <!--</div>-->
    </div>
   </div>
...
<script>
    import  mmenu from '../mmenu/mmenu.vue'
    import  mmain_news_imglist from '../mmain/mmain_news_imglist.vue'
    ...
    export default{
        ...
        data() {
            return{
                srcmenu: meitu.getUrl('html/images/menu.png'),
                showmenu:0,
                deviceHeight:0,
                platform:'',
                menuright:-750,
