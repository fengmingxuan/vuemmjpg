    ...
    <div style="height: 280px">
        ...
        <hlist  style="flex-direction: row;width: 750px;height: 100px;flex: 1"  loadmoreoffset="10" scroll-direction="horizontal">
            ...
            <cell v-for="stockitem in stockArray">
                <pcmingxing_tag_hlist_item :stockitem="stockitem"></pcmingxing_tag_hlist_item>
            </cell>
...
<script>
    ...
    import  pcmingxing_tag_hlist_item from '../mingxing/pcmingxing_tag_hlist_item.vue'
