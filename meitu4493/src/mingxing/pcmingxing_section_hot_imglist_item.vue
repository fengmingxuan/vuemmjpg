<template>
    <div style="flex-direction: row;flex: 1;margin: 5px;padding: 10;background-color: #fff;" @click="todetail(stockitem.href,stockitem.alt)">
        <text style="width: 100">{{stockitem.title}}</text>
