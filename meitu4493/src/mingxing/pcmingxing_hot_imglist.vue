    ...
    <div style="background-color:rgba(0, 0, 0, .25) ">
        ...
        <list class="list"  loadmoreoffset="10">
            ...
            <cell v-for="stockitem in stockArray">
                <pcmingxing_hot_imglist_item :stockitem="stockitem"></pcmingxing_hot_imglist_item>
            </cell>
            <!--<cell>-->
...
<script>
    ...
    import  pcmingxing_hot_imglist_item from '../mingxing/pcmingxing_hot_imglist_item.vue'
