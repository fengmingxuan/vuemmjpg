    ...
    <div style="background-color:rgba(0, 0, 0, .25) ">
        ...
        <list class="list"  loadmoreoffset="10">
            ...
            <cell v-for="stockitem in stockArray">
                <pcmingxing_section_hot_imglist_item :stockitem="stockitem"></pcmingxing_section_hot_imglist_item>
            </cell>
...
<script>
    ...
    import  pcmingxing_section_hot_imglist_item from '../mingxing/pcmingxing_section_hot_imglist_item.vue'
    ...
    export default{
        components: {
            pcmingxing_section_hot_imglist_item,
            navbar_v,
        },
        props: ['taghref'],
        data(){
