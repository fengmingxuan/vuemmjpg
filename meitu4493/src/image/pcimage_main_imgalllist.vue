    ...
    <div style="background-color:rgba(0, 0, 0, .25) ">
        ...
        <list class="list"  loadmoreoffset="10">
            ...
            <cell v-for="stockitem in stockArray">
                <pcimage_main_imgalllist_item :stockitem="stockitem"></pcimage_main_imgalllist_item>
            </cell>
            <cell>
...
<script>
    ...
    import  pcimage_main_imgalllist_item from '../image/pcimage_main_imgalllist_item.vue'
