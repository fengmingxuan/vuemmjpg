    ...
    <div style="background-color:rgba(0, 0, 0, .25) ">
        ...
        <list class="list"  loadmoreoffset="10">
            ...
            <cell v-for="stockitem in stockArray">
                <pctop_left_imglist_item :stockitem="stockitem"></pctop_left_imglist_item>
            </cell>
...
<script>
    ...
    import  pctop_left_imglist_item from '../paihang/pctop_left_imglist_item.vue'
