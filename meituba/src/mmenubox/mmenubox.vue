    ...
    <div style="background-color:rgba(0, 0, 0, .25) ">
        ...
        <list class="list"  loadmoreoffset="10">
            ...
            <cell v-for="tpicNitem in tpicNArray">
                <mmenubox_item :tpicNitem="tpicNitem"></mmenubox_item>
            </cell>
            <cell>
                <mmaintaglist :taghref="taghref"></mmaintaglist>
            </cell>
...
<script>
    ...
    import  mmenubox_item from '../mmenubox/mmenubox_item.vue'
    import  mmaintaglist from '../mmenubox/mmaintaglist.vue'
