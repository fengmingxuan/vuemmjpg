<template>
    <div style="background-color:rgba(0, 0, 0, .25) ">
        ...
        <list class="list"  loadmoreoffset="10">
            ...
            <cell>
                <pcslidersearch :taghref="taghref"></pcslidersearch>
            </cell>

            <cell v-for="tpicNitem in tpicNArray">
                <pcsearchlist_item :tpicNitem="tpicNitem"></pcsearchlist_item>
            </cell>
...
<script>
    ...
    import  pcsearchlist_item from '../search/pcsearchlist_item.vue'
    import  pcslidersearch from '../search/pcslidersearch.vue'
