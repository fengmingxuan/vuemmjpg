    ...
    <div style="background-color:rgba(0, 0, 0, .25) ">
        ...
        <list class="list"  loadmoreoffset="10">
            ...
            <cell v-for="stockitem in stockArray">
                <pcchannel_other_imglist_item :stockitem="stockitem"></pcchannel_other_imglist_item>
            </cell>
            <cell>
...
<script>
    ...
    import  pcchannel_other_imglist_item from '../channelother/pcchannel_other_imglist_item.vue'
                ...
                weexMeitubaJsoupModule.pcchannelotherimglist(params,function(e){
                    ...
                    if (json.list) {
                        if (json.list && json.list.length > 0) {
                            ...
                            var paramsCache = {
                                url:url,
                                typename: "pcchannelotherimglist"+self.pageNo
                            };
