<template>
    <div style="background-color:rgba(0, 0, 0, .25);height: 1223 ">
        ...
        <list class="list"  loadmoreoffset="10">
            ...
            <cell v-for="stockitem in stockArray">
                <pcarticle_channelupdate_item :stockitem="stockitem"></pcarticle_channelupdate_item>
            </cell>
            <!--<cell>-->
...
<script>
    ...
    import  pcarticle_channelupdate_item from '../article/pcarticle_channelupdate_item.vue'
