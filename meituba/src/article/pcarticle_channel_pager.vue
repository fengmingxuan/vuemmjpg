    ...
    <div class="content">
        ...
        <slider class="slider" append="tree" :interval="1000" needloop="false" :auto-play="false" @change="onchange"
            ...
            <div v-for="item in buttomData" style="width: 750;height: 1334">
                <pcarticle_channelupdate_notitlebar :ref="item.id"></pcarticle_channelupdate_notitlebar>
            </div>
...
<script>
    ...
    import  pcarticle_channelupdate_notitlebar from '../article/pcarticle_channelupdate_notitlebar.vue'
    ...
    export default{
        components: {
            pcarticle_channelupdate_notitlebar,
            navbar_v
