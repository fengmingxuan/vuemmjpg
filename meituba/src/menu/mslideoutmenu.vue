   ...
   <div class="wrapper">
    ...
    <div id="main" class="panel" v-bind:style="{ left: panelleft}" @click="toggle">
        <!--<div class="btn-hamburger" >-->
            <mmain_meituba_imglist></mmain_meituba_imglist>
        <!--</div>-->
    </div>
   </div>
...
<script>
    import  mmenubox from '../mmenubox/mmenubox.vue'
    import  mmain_meituba_imglist from '../mchannel/mmain_meituba_imglist.vue'
