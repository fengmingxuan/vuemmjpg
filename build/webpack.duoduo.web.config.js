...
var webSrcDirectory = path.join(__dirname, '../duoduo/web-entry');
...
function walk(dir) {
  dir = dir || '.';
  var directory = path.join(__dirname, '../duoduo', dir);
  ...
  fs.readdirSync(directory)
    .forEach(function(file) {
      ...
      if (stat.isFile() && extname === '.vue') {
        ...
        var name = path.join('duoduo', 'build/vue-web', /*path.relative('vue', dir)*/dir, path.basename(file, extname));
