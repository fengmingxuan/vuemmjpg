...
var webSrcDirectory = path.join(__dirname, '../meitu4493/web-entry');
...
function walk(dir) {
  dir = dir || '.';
  var directory = path.join(__dirname, '../meitu4493', dir);
  ...
  fs.readdirSync(directory)
    .forEach(function(file) {
      ...
      if (stat.isFile() && extname === '.vue') {
        ...
        var name = path.join('meitu4493', 'build/vue-web', /*path.relative('vue', dir)*/dir, path.basename(file, extname));
