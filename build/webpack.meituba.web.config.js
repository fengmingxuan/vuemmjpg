...
var webSrcDirectory = path.join(__dirname, '../meituba/web-entry');
...
function walk(dir) {
  dir = dir || '.';
  var directory = path.join(__dirname, '../meituba', dir);
  ...
  fs.readdirSync(directory)
    .forEach(function(file) {
      ...
      if (stat.isFile() && extname === '.vue') {
        ...
        var name = path.join('meituba', 'build/vue-web', /*path.relative('vue', dir)*/dir, path.basename(file, extname));
