...
var webSrcDirectory = path.join(__dirname, '../mmjpg/web-entry');
...
function walk(dir) {
  dir = dir || '.';
  var directory = path.join(__dirname, '../storm', dir);
  ...
  fs.readdirSync(directory)
    .forEach(function(file) {
      ...
      if (stat.isFile() && extname === '.vue') {
        ...
        var name = path.join('mmjpg', 'build/vue-web', /*path.relative('vue', dir)*/dir, path.basename(file, extname));
