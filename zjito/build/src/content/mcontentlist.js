...
/***/ (function(module, exports, __webpack_require__) {
	...
	var _mlinkhot = __webpack_require__(57);

	var _mlinkhot2 = _interopRequireDefault(_mlinkhot);
	...
	exports.default = {
	    ...
	    methods: {
	        ...
	        refresh: function refresh() {
	            ...
	            weexZjitoJsoupModule.mcontentlist(params, function (e) {
	                var json = JSON.parse(e);
	                if (self.pageNo == 1) {
	                    self.stockArray.splice(0, self.stockArray.length);
	                }
	                if (json.list) {
	                    if (json.list && json.list.length > 0) {
	                        ...
	                        var paramsCache = {
	                            url: url,
	                            typename: "mcontentlist" + self.pageNo
	                        };
	                        weexEventModule.saveCache(paramsCache, json, function (ee) {});
	                    } else {
	                        //异常
...
/***/ (function(module, exports) {
	...
	module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
	  ...
	  }, [_c('mimglist_notitlebar_autorefresh', {
	    attrs: {
	      "taghref": _vm.taghref
	    }
	  })], 1), _c('loading', {
