    ...
    <div>
        ...
        <list class="list"  loadmoreoffset="10">
            ...
            <cell v-for="stockitem in stockArray">
                <mtabimglist_item_v :stockitem="stockitem"></mtabimglist_item_v>
            </cell>
...
<script>
    ...
    import  mtabimglist_item_v from '../mtabimg/mtabimglist_item_v.vue'
    import  mtabtags from '../cat/mtabtags.vue'
