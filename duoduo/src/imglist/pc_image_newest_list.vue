    ...
    <div style="background-color:rgba(0, 0, 0, .25) ">
        ...
        <list class="list"  loadmoreoffset="10">
            ...
            <cell v-for="stockitem in stockArray">
                <pc_image_newest_list_item :stockitem="stockitem"></pc_image_newest_list_item>
            </cell>
            <!--<cell>-->
...
<script>
    ...
    import  pc_image_newest_list_item from './pc_image_newest_list_item.vue'
