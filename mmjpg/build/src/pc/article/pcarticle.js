...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/4f7aa865ae05316613881ba1bdb5c131', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/4f7aa865ae05316613881ba1bdb5c131',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/pcarticleitem', [], function(__weex_require__, __weex_exports__, __weex_module__) {
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    data: function () {return {
	        ...
	        showleft: true,
	        shown: true,
	        taghref: mmjpg.getm_mmjpg_article(),
	        deviceHeight: 1334,
	        url: ''
	    }},
	    created: function created() {
	    ...
	    ready: function ready() {
	        ...
	        self.$vm('pcmaintoppagerid').autoRefresh();
	        self.$vm('pcmainhotlistid').autoRefresh();
	        self.$vm('pcmainlikelistid').autoRefresh();
	        self.$vm('pcmainmmgridid').autoRefresh();
	    },
	    methods: {
	        ...
	        refresh: function refresh() {
	            ...
	            weexJsoupModule.pcarticlelist(params, function (e) {
	                self.refresh_display = 'hide';
	                self.showLoading = 'hide';
	                self.refreshing = "false";
	                var json;
