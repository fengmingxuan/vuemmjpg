...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/bc62694a37b674ee43f028d600d9e1ba', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/bc62694a37b674ee43f028d600d9e1ba',undefined,undefined)
	      ...
	      "children": [
	        {
	          ...
	          "attr": {
	            "value": function () {return this.dayitem.alt}
	          }
	        }
	      ]
	    },
...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/mmonth-item', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	      ...
	      "children": [
	        {
	          ...
	          "classList": function () {return ['tucao_numClass', 'textClass-' + (this.skinType)]},
	          "attr": {
	            "value": function () {return this.stockitem.month}
	          }
	        },
	        {
	          "type": "div",
	          "repeat": {
	            "expression": function () {return this.stockitem.list},
	            "value": "dayitem"
	          },
	          "children": [
	            {
	              "type": "mday-item",
	              "attr": {
	                "dayitem": function () {return this.dayitem}
	              }
	            }
	          ]
	        }
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    data: function () {return {
	        ...
	        showleft: true,
	        shown: true,
	        taghref: mzitu.getmzitu_m_all(),
	        deviceHeight: 1334,
	        url: mzitu.getmzitu_m_all()
	    }},
	    created: function created() {
	        var self = this;
	        this.platform = this.$getConfig().env.platform;
	    ...
	    methods: {
	        ...
	        refresh: function refresh() {
	            ...
	            weexMzituJsoupModule.mall(url, function (e) {
