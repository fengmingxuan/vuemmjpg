...
/***/ function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/d1005c3f27b8935fdf65615781742811', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/d1005c3f27b8935fdf65615781742811',undefined,undefined)
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    data: function () {return {
	        ...
	        showleft: true,
	        shown: true,
	        taghref: mzitu.getmzitu_m_zipai(),
	        deviceHeight: 1334,
	        url: mzitu.getmzitu_m_zipai(),
	        pagenumbers: mzitu.getmzitu_m_zipai()
	    }},
	    created: function created() {
	        var self = this;
	        this.platform = this.$getConfig().env.platform;
	    ...
	    methods: {
	        ...
	        refresh: function refresh() {
	            ...
	            weexMzituJsoupModule.mzipai(params, function (e) {
	                self.refresh_display = 'hide';
	                self.showLoading = 'hide';
	                self.refreshing = "false";
	                var json;
