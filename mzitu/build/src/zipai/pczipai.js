...
/***/ (function(module, exports, __webpack_require__) {
	...
	__weex_define__('@weex-component/e84df025123cda6fe573cd69ef8882d6', [], function(__weex_require__, __weex_exports__, __weex_module__) {
	...
	__weex_bootstrap__('@weex-component/e84df025123cda6fe573cd69ef8882d6',undefined,undefined)
...
/***/ (function(module, exports, __webpack_require__) {
	...
	module.exports = {
	    ...
	    data: function () {return {
	        ...
	        showleft: true,
	        shown: true,
	        taghref: mzitu.getmzitu_pc_zipai(),
	        deviceHeight: 1334,
	        url: mzitu.getmzitu_pc_zipai(),
	        pagenumbers: 1
	    }},
	    created: function created() {
	        var self = this;
	    ...
	    methods: {
	        ...
	        refresh: function refresh() {
	            ...
	            if (self.pageNo > 1) {
	                ...
	                url = self.taghref + 'comment-page-' + self.pagenumbers + '/#comments';
	            }
	            self.url = url;
	            var params = {
	                url: url,
	            ...
	            weexMzituJsoupModule.pccommentlist(params, function (e) {
	                self.refresh_display = 'hide';
	                self.showLoading = 'hide';
	                self.refreshing = "false";
	                var json;
	                ...
	                if (json.list) {
	                    if (json.list && json.list.length > 0) {
	                        ...
	                        var paramsCache = {
	                            url: url,
	                            typename: "pccommentlist" + self.pageNo
	                        };
	                        weexEventModule.saveCache(paramsCache, json, function (ee) {});
	                    } else {
	                        console.log('异常====');
